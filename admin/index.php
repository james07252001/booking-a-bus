...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .nav-link .icon {
                display: block; /* Icons above text */
                margin-bottom: 5px;
            }
        }
        ...
        @media (max-width: 375px) {
            .nav-item {
                width: 100%; /* Single item per row margin-left: 543px;
                margin-top: -40px;*/
            }
            .dropdown {
                left: -320px;  /* Resetting position for small screens */
                top: 5px;
            }
...
<body class="bg-light">
    ...
    <div class="wrapper">
        <div class="navigation" style="background-image: linear-gradient(60deg, #3d3393 0%, #2b76b9 37%, #2cacd1 65%, #35eb93 100%);">
            <ul class="nav flex-column" style="background-image: linear-gradient(60deg, #3d3393 0%, #2b76b9 37%, #2cacd1 65%, #35eb93 100%);">
                <img src="../assets/images/bobrs.png" class="w3-circle" alt="" style="width:50%">
             ...
             <li>
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'booking') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=booking">
                        <span class="icon">
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'schedules') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=schedules">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                                fill="#FFF">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'routes') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=routes">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                                fill="#FFF">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'bus') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=bus">
                        <span class="icon">
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'driver') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=driver">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                                fill="#FFF">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li
                    ...
                    <a class="nav-link text-white" href="index?page=conductor">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                                fill="#ffff">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li
                    ...
                    <a class="nav-link text-white" href="index?page=customer">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                                fill="#FFF">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'users') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=users">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                                fill="#FFF">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'reports') echo 'bg-primary' ?>">
                    <a class="nav-link text-white" href="index?page=reports">
                        <span class="icon">
        ...
        <div class="main">
            <nav class="navbar navbar-light bg-white justify-content-between">
                <a class="navbar-brand toggle" href="#" onclick="toggleMenu()">
                    ...
                    <span style="font-size: 'Times New Roman', "><b> BANTAYAN ONLINE BUS</b></span>
                </a>

                <!-- Notification Bell Start -->
<li class="nav-item dropdown" style="margin-left: 543px; margin-top: -40px;">
    <a class="nav-link text-white" href="#" id="notificationDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="icon">
            <img src="../assets/img/notif.png" alt="Notifications" style="width: 30px; height: 26px; top: 42px; left: -11px; position: absolute;">
        </span>
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notificationDropdown">
        <?php if ($pendingCount > 0): ?>
            <?php foreach ($pendingBookings as $booking): ?>
                <a class="dropdown-item booking-item" href="index?page=booking&id=<?php echo $booking['id']; ?>">
