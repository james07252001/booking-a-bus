        ...
        success: function(dataResult) {
            ...
            if (dataResult.statusCode == 200) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: dataResult.message || 'An error occurred. Please try again.',
                });
            }
        },
        error: function() {
        ...
        success: function(dataResult) {
            ...
            if (dataResult.statusCode == 200) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: dataResult.message || 'An error occurred while updating the schedule.',
                });
            }
        },
        error: function() {
...
function updateStatus(id, status) {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: 'Do you want to update the schedule status?',
        icon: 'warning',
        showCancelButton: true,
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult.statusCode == 200) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: dataResult.message || 'An error occurred while updating the status.',
                        });
                    }
                },
                error: function() {
