...
<div class="col-6 col-sm-4 col-md-3 mb-3">
    <div class="bg-white shadow border-top p-3 border-primary rounded h-100" 
        style="background-color: #FFFFFF; background-image: linear-gradient(to top, #fff1eb 0%, #ace0f9 100%);">
        <div class="d-flex align-items-center">
            <!-- Updated Icon -->
            <img src="https://img.icons8.com/?size=100&id=20215&format=png&color=000000" 
                alt="Total Fare Icon" height="50px" width="50px" class="pulse-icon" />
