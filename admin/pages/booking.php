            ...
            <?php
                foreach ($bookings as &$row) {
                    if ($row['payment_status'] == 'pending') {
                        ...
                        // Upload ID calculation (assuming it exists in the $row array)
                        $upload_id = isset($row['upload_id']) ? $row['upload_id'] : 'N/A';
                        ...
                        $total_with_luggage = $total + $luggage_fee;
            ?>
                    ...
                    <div id="<?php echo 'print_'.$row['book_id'] ?>">
                        ...
                        <div class="p-3">
                            ...
                            <p class="mb-0 d-flex align-items-center justify-content-between">
                                <span class="text-muted">
                                    ...
                                    <i class="fas fa-info-circle" 
                                       data-toggle="tooltip" 
                                       data-placement="top" 
                                       title="Unique identifier for uploaded documents"></i>
                                </span>
                                <span>
                                    <span class="font-weight-bold mr-2"><?php echo $upload_id; ?></span>
                                    <?php if (!empty($upload_path)): ?>
                                    <button 
                                        class="btn btn-sm btn-info view-upload-id" 
                                        data-toggle="modal" 
                                        data-target="#uploadIdModal<?php echo $row['book_id']; ?>"
                                        data-upload-path="<?php echo htmlspecialchars($upload_path); ?>"
                                    >
                                        View ID
                                    </button>
                                    <?php endif; ?>
                            ...
                            <p class="d-flex align-items-center justify-content-between mb-0">
                                ...
                                <strong><?php echo number_format($total_with_luggage, 2); ?></strong>
                            </p>
                        </div>
                        <div class="p-3">
                ...
                <div id="<?php echo 'print_'.$row['book_id'] ?>">
                    ...
                    <div class="p-3">
                        <div class="p-3">
                            ...
                            <p class="d-flex align-items-center justify-content-between mb-0">
                                <span class="text-muted d-block">Fare:</span>
                                <strong><?php echo number_format($row['fare'], 2) ?></strong>
                            </p>
                            <!-- Luggage Count and Fee -->
                            <p class="d-flex align-items-center justify-content-between mb-0">
                                <span class="text-muted d-block">Luggage Count:</span>
