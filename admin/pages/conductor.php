            ...
            <table id="myTable" class="table table-striped">
                ...
                ?>
                    <tr id="<?php echo $row["id"]; ?>">
                        <th scope="row" data-label="#"> <?php echo $i; ?></th>
                        <td data-label="Fullname"><?php echo $row["name"]; ?></td>
                        <td data-label="Contact"><?php echo $row["phone"]; ?></td>
        ...
        success: function(dataResult) {
            ...
            if (dataResult.statusCode == 200) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    text: 'New conductor added successfully!'
                }).then(() => {
                    location.reload();
                });
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: 'Conductor Already Taken' // Display the duplicate error message
                });
            }
        },
    });
        ...
        success: function(dataResult) {
            ...
            if (dataResult.statusCode == 200) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Updated!',
                    text: 'Conductor updated successfully!'
                }).then(() => {
                    location.reload();
                });
            } else if (dataResult.statusCode == 201) {
    ...
    $.ajax({
        ...
        success: function(dataResult) {
            Swal.fire({
                icon: 'success',
                title: 'Deleted!',
                text: 'Conductor deleted successfully!'
            }).then(() => {
