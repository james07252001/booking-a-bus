...
if (count($_POST) > 0) {
    ...
    if ($_POST['type'] == 1) {
        ...
        if (!validEmail($email)) {
            ...
            echo json_encode(array("statusCode" => 500, "title" => "Password must be at least 8 characters long."));
            ...
            $hashedPwd = password_hash($password, PASSWORD_ARGON2I); // Argon2i hashing
