        ...
        <div class="w-100 bg-white shadow-sm p-4 login-form">
            ...
            <div class="p-3">
                ...
                <form method="POST" action="">
                    ...
                    <button type="submit" class="btn btn-block btn-login-glow" name="sign-in-submit">Login</button>
...
background: linear-gradient(to right, #db36a4, #f7ff00); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    z-index: -1; /* Position it behind the button */
    transition: box-shadow 0.3s ease-in-out; /* Smooth transition for glow */
}

.btn-login-glow:hover::before {
    box-shadow: 0 0 15px 5px #4e73df; /* Glowing effect around the border */
}
