        ...
        <div class="bg-white shadow-sm w-100 m-auto" style="max-width: 500px">
            ...
            <div class="p-3">
                ...
                <div class="form-group" id="luggageSection" style="display: none;">
                    ...
                    <input id="luggage" class="form-control" type="number" min="0" placeholder="Enter number of luggage" />
                </div>
...
formData.append('luggage_fee', (luggageCount * luggage_fee_per_piece).toFixed(2)); // Calculate luggage fee
formData.append('discount', (fare * discount).toFixed(2)); // Calculate discount amount

// Append the uploaded file to the FormData
if (uploadIdFile) {
    formData.append('upload_proof', uploadIdFile);
}
