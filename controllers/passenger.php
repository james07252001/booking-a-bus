<?php
    class Passenger
    {
        ...
        {   
            ...
            if($hashedPwd){
                mysqli_stmt_bind_param($stmt, "sssss", $this->first_name, $this->last_name, $this->email, $this->phone_number, $this->address, $hashedPwd);
            }else{
                mysqli_stmt_bind_param($stmt, "ssss", $this->first_name, $this->last_name, $this->email, $this->phone_number, $this->address);
            }
        ...
        public function login($email, $password){
            ...
            if($checkPwd === false){
                ...
                $_SESSION["userPhone"] = $isExists['phone_number'];
